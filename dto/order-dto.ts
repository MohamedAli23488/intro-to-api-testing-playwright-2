export class OrderDto {
  ...
  static createOpenOrderWithRandomData(): OrderDto {
    return new OrderDto('John Doe', '+123456789', 'Urgent order', Math.floor(Math.random() * 10))
  }
  //   create order with low priority
  static createOpenOrderWithLowPriority(): OrderDto {
    return new OrderDto('John Doe', '+123456789', 'low priority', Math.floor(Math.random() * 10))
  }
}
